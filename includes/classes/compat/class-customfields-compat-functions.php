<?php
/**
 * Class CustomFields_Compat_Functions - class-customfields-compat-functions.php
 *
 * @author   Jake Evans
 * @category Admin
...
if ( ! class_exists( 'CustomFields_Compat_Functions', false ) ) :
	/**
	 * CustomFields_Compat_Functions class. Here we'll run functions that make older versions of WPBookList compatible with newest version
	 */
	class CustomFields_Compat_Functions {
		 ...
		 */
		public function customfields_update_version_number_function() {
